/* @ts-self-types="./dropletbox.d.ts" */

export class DropletboxApp {
    static __wrap(ptr) {
        ptr = ptr >>> 0;
        const obj = Object.create(DropletboxApp.prototype);
        obj.__wbg_ptr = ptr;
        DropletboxAppFinalization.register(obj, obj.__wbg_ptr, obj);
        return obj;
    }
    __destroy_into_raw() {
        const ptr = this.__wbg_ptr;
        this.__wbg_ptr = 0;
        DropletboxAppFinalization.unregister(this);
        return ptr;
    }
    free() {
        const ptr = this.__destroy_into_raw();
        wasm.__wbg_dropletboxapp_free(ptr, 0);
    }
    /**
     * @returns {any}
     */
    clearUpload() {
        try {
            ...
            wasm.dropletboxapp_clearUpload(retptr, this.__wbg_ptr);
    ...
    create_invoice(request) {
        const ret = wasm.dropletboxapp_create_invoice(this.__wbg_ptr, addHeapObject(request));
    ...
    currentSwap() {
        try {
            const retptr = wasm.__wbindgen_add_to_stack_pointer(-16);
            wasm.dropletboxapp_currentSwap(retptr, this.__wbg_ptr);
            var r0 = getDataViewMemory0().getInt32(retptr + 4 * 0, true);
            var r1 = getDataViewMemory0().getInt32(retptr + 4 * 1, true);
            var r2 = getDataViewMemory0().getInt32(retptr + 4 * 2, true);
            if (r2) {
    ...
    currentUpload() {
        try {
            const retptr = wasm.__wbindgen_add_to_stack_pointer(-16);
            wasm.dropletboxapp_currentUpload(retptr, this.__wbg_ptr);
            var r0 = getDataViewMemory0().getInt32(retptr + 4 * 0, true);
            var r1 = getDataViewMemory0().getInt32(retptr + 4 * 1, true);
            var r2 = getDataViewMemory0().getInt32(retptr + 4 * 2, true);
            if (r2) {
    ...
    currentUploadPreview() {
        try {
            const retptr = wasm.__wbindgen_add_to_stack_pointer(-16);
            wasm.dropletboxapp_currentUploadPreview(retptr, this.__wbg_ptr);
            var r0 = getDataViewMemory0().getInt32(retptr + 4 * 0, true);
            var r1 = getDataViewMemory0().getInt32(retptr + 4 * 1, true);
            var r2 = getDataViewMemory0().getInt32(retptr + 4 * 2, true);
            if (r2) {
    ...
    exportSnapshot() {
        try {
            const retptr = wasm.__wbindgen_add_to_stack_pointer(-16);
            wasm.dropletboxapp_exportSnapshot(retptr, this.__wbg_ptr);
            var r0 = getDataViewMemory0().getInt32(retptr + 4 * 0, true);
            var r1 = getDataViewMemory0().getInt32(retptr + 4 * 1, true);
            var r2 = getDataViewMemory0().getInt32(retptr + 4 * 2, true);
            if (r2) {
    ...
    /**
     * @param {any} snapshot
     * @returns {DropletboxApp}
     */
    static fromSnapshot(snapshot) {
        try {
            const retptr = wasm.__wbindgen_add_to_stack_pointer(-16);
            wasm.dropletboxapp_fromSnapshot(retptr, addHeapObject(snapshot));
            var r0 = getDataViewMemory0().getInt32(retptr + 4 * 0, true);
            var r1 = getDataViewMemory0().getInt32(retptr + 4 * 1, true);
            var r2 = getDataViewMemory0().getInt32(retptr + 4 * 2, true);
            if (r2) {
            ...
            return DropletboxApp.__wrap(r0);
        } finally {
            wasm.__wbindgen_add_to_stack_pointer(16);
        }
    }
    constructor() {
        try {
            ...
            this.__wbg_ptr = r0 >>> 0;
            DropletboxAppFinalization.register(this, this.__wbg_ptr, this);
            return this;
        } finally {
            wasm.__wbindgen_add_to_stack_pointer(16);
        }
     ...
     */
    poll_once() {
        const ret = wasm.dropletboxapp_poll_once(this.__wbg_ptr);
        return takeObject(ret);
    }
    /**
     * @param {any} request
     * @returns {Promise<any>}
     */
    quoteInvoice(request) {
        const ret = wasm.dropletboxapp_quoteInvoice(this.__wbg_ptr, addHeapObject(request));
        return takeObject(ret);
    }
    /**
     * @returns {Promise<any>}
     */
    retryPendingSwap() {
        const ret = wasm.dropletboxapp_retryPendingSwap(this.__wbg_ptr);
        return takeObject(ret);
    }
    /**
     * @param {any} request
    ...
    setUpload(request) {
        try {
            const retptr = wasm.__wbindgen_add_to_stack_pointer(-16);
            wasm.dropletboxapp_setUpload(retptr, this.__wbg_ptr, addHeapObject(request));
            var r0 = getDataViewMemory0().getInt32(retptr + 4 * 0, true);
            var r1 = getDataViewMemory0().getInt32(retptr + 4 * 1, true);
            var r2 = getDataViewMemory0().getInt32(retptr + 4 * 2, true);
            if (r2) {
    ...
    wallet() {
        try {
            const retptr = wasm.__wbindgen_add_to_stack_pointer(-16);
            wasm.dropletboxapp_wallet(retptr, this.__wbg_ptr);
            var r0 = getDataViewMemory0().getInt32(retptr + 4 * 0, true);
            var r1 = getDataViewMemory0().getInt32(retptr + 4 * 1, true);
            var r2 = getDataViewMemory0().getInt32(retptr + 4 * 2, true);
            if (r2) {
...
if (Symbol.dispose) DropletboxApp.prototype[Symbol.dispose] = DropletboxApp.prototype.free;

/**
 * @param {string} tx_hex
 * @returns {any}
 */
export function decodeRevealPayload(tx_hex) {
    try {
        const retptr = wasm.__wbindgen_add_to_stack_pointer(-16);
        const ptr0 = passStringToWasm0(tx_hex, wasm.__wbindgen_export, wasm.__wbindgen_export2);
        const len0 = WASM_VECTOR_LEN;
        wasm.decodeRevealPayload(retptr, ptr0, len0);
        var r0 = getDataViewMemory0().getInt32(retptr + 4 * 0, true);
        var r1 = getDataViewMemory0().getInt32(retptr + 4 * 1, true);
        var r2 = getDataViewMemory0().getInt32(retptr + 4 * 2, true);
        if (r2) {
...
function __wbg_get_imports() {
    const import0 = {
        ...
        __wbg_headers_f086963476d86171: function(arg0) {
            const ret = getObject(arg0).headers;
            return addHeapObject(ret);
        },
        ...
        __wbg_new_694161c660bbefba: function(arg0, arg1) {
            try {
                ...
                var cb0 = (arg0, arg1) => {
                    ...
                    state0.a = 0;
                    try {
                        return __wasm_bindgen_func_elem_3998(a, state0.b, arg0, arg1);
                    } finally {
                        state0.a = a;
                    }
                };
        ...
        __wbindgen_cast_0000000000000001: function(arg0, arg1) {
            ...
            const ret = makeMutClosure(arg0, arg1, __wasm_bindgen_func_elem_3996);
            return addHeapObject(ret);
        },
        __wbindgen_cast_0000000000000002: function(arg0, arg1) {
            ...
            const ret = makeMutClosure(arg0, arg1, __wasm_bindgen_func_elem_1921);
            return addHeapObject(ret);
        },
    ...
    return {
        __proto__: null,
        "./dropletbox_bg.js": import0,
    };
}

function __wasm_bindgen_func_elem_1921(arg0, arg1) {
    wasm.__wasm_bindgen_func_elem_1921(arg0, arg1);
}

function __wasm_bindgen_func_elem_3996(arg0, arg1, arg2) {
    try {
        const retptr = wasm.__wbindgen_add_to_stack_pointer(-16);
        wasm.__wasm_bindgen_func_elem_3996(retptr, arg0, arg1, addHeapObject(arg2));
        var r0 = getDataViewMemory0().getInt32(retptr + 4 * 0, true);
        var r1 = getDataViewMemory0().getInt32(retptr + 4 * 1, true);
        if (r1) {
            throw takeObject(r0);
...
function __wasm_bindgen_func_elem_3998(arg0, arg1, arg2, arg3) {
    wasm.__wasm_bindgen_func_elem_3998(arg0, arg1, addHeapObject(arg2), addHeapObject(arg3));
}
...
const DropletboxAppFinalization = (typeof FinalizationRegistry === 'undefined')
    ? { register: () => {}, unregister: () => {} }
    : new FinalizationRegistry(ptr => wasm.__wbg_dropletboxapp_free(ptr >>> 0, 1));
...
async function __wbg_init(module_or_path) {
    ...
    if (module_or_path === undefined) {
        module_or_path = new URL('dropletbox_bg.wasm', import.meta.url);
    }
    const imports = __wbg_get_imports();
